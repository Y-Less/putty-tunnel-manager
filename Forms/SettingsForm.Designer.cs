namespace JoeriBekker.PuttyTunnelManager.Forms
{
    partial class SettingsForm
    {
        ...
        private void InitializeComponent()
        {
			...
			this.autoOpenCB = new System.Windows.Forms.CheckBox();
			...
			// tabPage1
			// 
			this.tabPage1.Controls.Add(this.autoOpenCB);
			...
			// autoOpenCB
			// 
			this.autoOpenCB.AutoSize = true;
			this.autoOpenCB.Location = new System.Drawing.Point(9, 65);
			this.autoOpenCB.Name = "autoOpenCB";
			this.autoOpenCB.Size = new System.Drawing.Size(229, 17);
			this.autoOpenCB.TabIndex = 3;
			this.autoOpenCB.Text = "Open tunnels with PuTTY Tunnel Manager";
			this.autoOpenCB.UseVisualStyleBackColor = true;
			this.autoOpenCB.CheckedChanged += new System.EventHandler(this.autoOpenCB_CheckedChanged);
			// 
		...
		private System.Windows.Forms.CheckBox autoOpenCB;
    }
}
